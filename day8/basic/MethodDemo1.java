...
public class MethodDemo1 {
   ...
   // <access modifier > void < method name> (){
    ...
    //   ========
    //}
    public void displayInfo(String name, int age , double salary , boolean active ){//the written information is parameters
    ...
    public static void main(String[] args) {
        ...
        ob.displayInfo("Sujan", 22, 1500 , true);//these are arguments
        ...
        ob.displayInfo(name, age, salary,status);
    }
}
